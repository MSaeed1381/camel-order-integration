...
\begin{terms}
  \item \term{خطای گذرای خواندن یا پردازش} در صورت بروز خطای گذرا هنگام خواندن یا پردازش فایل، سازوکار تحویل مجدد\footnote{\lr{Retry / Redelivery}} تا ۳ بار تلاش می‌کند؛ در صورت تداوم خطا، پیام بدون متوقف‌کردن سیستم به کانال پیام‌های مرده در \lr{data/error} منتقل می‌شود.
  \item \term{عدم دسترسی به پوشه‌ی خروجی}\footnote{\lr{GenericFileOperationFailedException}} در صورت شکست در نوشتن روی پوشه‌ی خروجی، داده‌ها موقتاً در پوشه‌ی واسط (\lr{data/temp}) ذخیره می‌شوند. فایل تا زمانی که پوشه‌ی خروجی در دسترس نباشد در \lr{data/temp} باقی می‌ماند و در هر چرخه‌ی بازیابی مجدداً تلاش می‌شود؛ پس از رفع مشکل، به مسیر اصلی بازمی‌گردد.
